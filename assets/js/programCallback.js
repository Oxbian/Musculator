...
function showPrograms(data)
{
    ...
    data.forEach(element => {
        ...
        + ' btn-secondary editProgram"><i class="bi bi-pencil-square"></i></button><button type="button" class="btn btn-danger deleteProgram"><i class="bi bi-trash">' +
        '</i></button></div><button type="button" class="btn btn-primary me-3 addExercise"><i class="bi bi-plus-square"></i> Add exercise</button></div><table class="table"><thead><tr><th scope="col">Exercise name</th>'+
