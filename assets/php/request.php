...
if ($requestRessource == 'exercise') {
  switch ($requestMethod) {
    ...
    case 'POST':
      if ($login != NULL) {
        if (
          isset($_POST['name']) && isset($_POST['serie']) && isset($_POST['repetition']) &&
    ...
    case 'PUT':
      if ($login != NULL) {
        ...
        if ($id != NULL) {
          ...
          if (
            isset($_PUT['name']) && empty($_PUT['name']) == false &&
...
if ($requestRessource == 'session') {
  switch ($requestMethod) {
    ...
    case 'POST':
      if ($login != NULL) {
        if (
          isset($_POST['repetition']) && isset($_POST['serie']) && isset($_POST['date']) &&
